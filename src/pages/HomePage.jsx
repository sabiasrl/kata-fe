...
const HomePage = () => (
  <div className="main-card" style={{ maxWidth: 700, margin: '2rem auto' }}>
    <h1 style={{ fontWeight: 700, fontSize: '2.2rem', color: '#232f3e', marginBottom: 8 }}>Welcome to Kata Online Bookstore</h1>
    ...
    <div style={{ background: '#f4f8fb', borderRadius: 8, padding: '1.5rem', boxShadow: '0 1px 4px rgba(0,120,212,0.06)', marginBottom: 16 }}>
      ...
      <ul style={{ color: '#333', fontSize: '1.05rem', paddingLeft: 20 }}>
        <li>API integration details</li>
        <li>How to run tests</li>
        <li>Project setup and more</li>
      </ul>
    </div>
  </div>
);
